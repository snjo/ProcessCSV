...
namespace ProcessCsv
{
    public class Menu
    {
        ...
        public Menu(CsvArguments arguments)
        {
            ...
            errorMenu.Add(new MenuOption("Set column count", ActionSetFieldCount, argNone, argNone));
        ...
        private void ShowArguments()
        {
            ...
            ArgumentFormatted("Column Count", Arguments.ColumnCount.ToString(), comment: "0 = Autodetect. Override if Autodetect guesses wrong", padding: pad);
            ...
            ArgumentFormatted("Fix bad data", Arguments.FixBadData.ToString(), comment: "Fixes errors due to missing quotes or fields/columns", padding: pad, ErrorType.Normal, ConsoleColor.Yellow);
            ...
            ArgumentFormatted("Ignore missing fields", Arguments.IgnoreMissingField.ToString(), comment: "Ignores missing fields/columns, inserts blank fields", padding: pad, ErrorType.Normal, ConsoleColor.Yellow);
            /*
